...
class LeptonInfoBranches {
  ...
  public :
    ...
    //--------------------------
    int   nTrk;
    float Trk_d0[nMaxTrks_];
    float Trk_d0Error[nMaxTrks_];
    float Trk_dz[nMaxTrks_];
    float Trk_dzError[nMaxTrks_];
    float Trk_p[nMaxTrks_];
    float Trk_pt[nMaxTrks_];
    float Trk_eta[nMaxTrks_];
    float Trk_phi[nMaxTrks_];
    float Trk_chi2[nMaxTrks_];
    int   Trk_charge[nMaxTrks_];
    float Trk_ndof[nMaxTrks_];
    ...
    void RegisterTree(TTree *tree, std::string name="") {
      ...
      // track information
      //--------------------------------------
      tree->Branch((name+"nTrk").c_str()           ,&nTrk          ,(name+"nTrk/I").c_str());
      tree->Branch((name+"Trk_d0").c_str()         ,Trk_d0         ,(name+"Trk_d0["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_d0Error").c_str()    ,Trk_d0Error    ,(name+"Trk_d0Error["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_dz").c_str()         ,Trk_dz         ,(name+"Trk_dz["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_dzError").c_str()    ,Trk_dzError    ,(name+"Trk_dzError["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_p").c_str()          ,Trk_p          ,(name+"Trk_p["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_pt").c_str()         ,Trk_pt         ,(name+"Trk_pt["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_eta").c_str()        ,Trk_eta        ,(name+"Trk_eta["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_phi").c_str()        ,Trk_phi        ,(name+"Trk_phi["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_chi2").c_str()       ,Trk_chi2       ,(name+"Trk_chi2["+name+"nTrk]/F").c_str());
      tree->Branch((name+"Trk_charge").c_str()     ,Trk_charge     ,(name+"Trk_charge["+name+"nTrk]/I").c_str());
      tree->Branch((name+"Trk_ndof").c_str()       ,Trk_ndof       ,(name+"Trk_ndof["+name+"nTrk]/I").c_str());
    }
    ...
    void ReadTree(TTree *tree, std::string name="") {
      ...
      // track information
      //--------------------------------------
      tree->SetBranchAddress((name+"nTrk").c_str()          ,&nTrk            ) ;
      tree->SetBranchAddress((name+"Trk_d0").c_str()        ,Trk_d0           ) ;
      tree->SetBranchAddress((name+"Trk_d0Error").c_str()   ,Trk_d0Error      ) ;
      tree->SetBranchAddress((name+"Trk_dz").c_str()        ,Trk_dz           ) ;
      tree->SetBranchAddress((name+"Trk_dzError").c_str()   ,Trk_dzError      ) ;
      tree->SetBranchAddress((name+"Trk_p").c_str()         ,Trk_p            ) ;
      tree->SetBranchAddress((name+"Trk_pt").c_str()        ,Trk_pt           ) ;
      tree->SetBranchAddress((name+"Trk_eta").c_str()       ,Trk_eta          ) ;
      tree->SetBranchAddress((name+"Trk_phi").c_str()       ,Trk_phi          ) ;
      tree->SetBranchAddress((name+"Trk_chi2").c_str()      ,Trk_chi2         ) ;
      tree->SetBranchAddress((name+"Trk_charge").c_str()    ,Trk_charge       ) ;
      tree->SetBranchAddress((name+"Trk_ndof").c_str()      ,Trk_ndof         ) ;
    }
